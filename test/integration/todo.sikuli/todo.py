...
dragDrop(digitPackageRegion.find("1372142855514.png"), Pattern("1379348761930.png").targetOffset(-73,27))
...
dragDrop("1371711022203.png", Pattern("1379359212690.png").targetOffset(-49,2))
