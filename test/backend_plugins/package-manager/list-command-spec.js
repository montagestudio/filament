...
describe("list command", function () {
    ...
    describe("no errors situation", function () {
        ...
        it('should gather correct information about the project', function() {
        ...
        it('should has no errors', function() {
        ...
        it('should detect when an ancestor dependency is used by a deepest dependency', function() {

            return Q.invoke(listCommand, 'run', DEFAULT_PROJECT_APP, true).then(function (tree) {
                expect(tree.dependencies[2].problems).not.toBeDefined();
            });
    ...
    describe("errors situation", function () {
        ...
        it('should detect an invalid regular or optional dependency version', function() {
            ...
            return Q.invoke(listCommand, 'run', DEFAULT_PROJECT_APP, true).then(function (tree) {
                ...
                expect(tree.dependencies[3].type).toEqual(DEPENDENCY_TYPE_OPTIONAL);
                ...
                expect(tree.dependencies[4].type).toEqual(DEPENDENCY_TYPE_DEV);
                expect(tree.dependencies[4].problems).not.toBeDefined();
            });

        });

        it('should detect an invalid ancestor dependency which its used by a deepest dependency', function() {
        ...
        it('should detect when the package.json file of the project shows some errors', function() {
