    ...
    */
    ...
    _dispatchTranslateStart: {
        value: function(x, y) {
            ...
            translateStartEvent.clientX = this._pointerX;
            translateStartEvent.clientY = this._pointerY;
    ...
    _dispatchTranslateEnd: {
        value: function() {
            ...
            translateEndEvent.clientX = this._pointerX;
            translateEndEvent.clientY = this._pointerY;
            // Event needs to be the same shape as the one in flow-translate-composer
    ...
    _dispatchTranslate: {
        value: function() {
            ...
            translateEvent.clientX = this._pointerX;
            translateEvent.clientY = this._pointerY;
            // Event needs to be the same shape as the one in flow-translate-composer
